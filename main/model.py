        ...
        with tf.device('/gpu:0'):
            with tf.variable_scope('deepcas') as scope:
                ...
                with tf.variable_scope('BiGRU'):
                    ...
                    # 拆分以获得n_steps个张量（n_sequences * batch_size，n_input）
                ...
                with tf.variable_scope('attention'):
                    ...
                    attention_batch = tf.pow(tf.multiply(p_geo, tf.ones_like(self.sz)),
                    ...
                    attention_result_t = tf.multiply(attention_batch_lin,
                                                     tf.reshape(attention_result, [-1, shape[2] * shape[3]]))
